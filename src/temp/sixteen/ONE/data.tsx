...
export const premiumBreakupRows = [
  {
    ...
    bold: false,
    columnValues: ["₹15,780", "₹20,782", "₹18,250", "₹14,500"],
  ...
  },
  {
    ...
    bold: false,
    columnValues: ["₹10,640", "₹10,790", "₹10,640", "₹10,640"],
  ...
  },
  {
    ...
    icon: <FiInfo size={14} />,
    bold: false,
    columnValues: ["₹4,000", "₹4,756", "₹4,327", "₹3,622"],
  ...
  },
  {
    ...
    icon: null,
    bold: true,
    columnValues: ["₹31,176", "₹31,176", "₹34,417", "₹28,762"],
...
export const addonDetailRows = [
  {
    ...
    icon: <FiShield size={14} />,
    bold: false,
    columnValues: [false, false, true, false],
  },
  {
    key: "engineProtect",
    ...
    bold: false,
    columnValues: [true, false, true, false],
  },
  {
    key: "zeroDep",
    ...
    icon: <FiStar size={14} />,
    bold: false,
    columnValues: [true, true, true, false],
  },
  {
    key: "roadside",
  ...
  },
  {
    ...
    icon: <FiInfo size={14} />,
    bold: false,
    columnValues: [false, true, true, false],
  },
  {
    key: "returnToInvoice",
